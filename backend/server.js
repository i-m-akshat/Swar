...
fastify.post('/api/job/:jobId/summarize', async (request, reply) => {
    ...
    const prompt = `You are Swar (स्वर) AI, an elite executive speech intelligence analyst.
...
Respond ONLY with valid JSON using this exact schema:
{
  ...
  "decisions": [
    ...
    try {
        ...
        const rawMarkdown = `# 🎙️ Swar (स्वर) Intelligence Report
...
---
_Generated by Swar (स्वर) Speech Intelligence Engine powered by Google Gemini._
`;
